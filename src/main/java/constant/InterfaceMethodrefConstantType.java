 ...
 * @date 2019/9/5
 */
public class InterfaceMethodrefConstantType implements ConstantType {

    private static final String tagStr = "InterfaceMethodref";
    ...
    public InterfaceMethodrefConstantType(ConstantType[] constantPool, int idx, short classIndex, short nameAndTypeIndex) {
