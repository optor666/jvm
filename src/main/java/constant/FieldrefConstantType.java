 ...
 * @date 2019/9/5
 */
public class FieldrefConstantType implements ConstantType {

    private static final String tagStr = "Fieldref";
    ...
    public FieldrefConstantType(ConstantType[] constantPool, int idx, short classIndex, short nameAndTypeIndex) {
